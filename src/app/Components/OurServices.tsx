        ...
        <div className="w-full  flex max-w-screen-xl    justify-center  md:mt-12">
          ...
          >
            ...
            <div className="">
              <Link href="/services">
                <button
                  className="my-4 px-3 w-fit  md:px-6 flex gap-x-2 py-3 mt-8 md:mt-0 border     bg-black
 text-white text-lg font-medium rounded-full hover:bg-white hover:text-black  border-black transition  justify-between items-center relative z-40 "
                  style={{
                    fontSize: "1rem",
                  }}
                  id="casestudies"
                    ...
                    <defs>
                      <clipPath id="clip0_233_16584">
                        <rect
                          ...
                          height="16"
                          fill="white"
                          transform="translate(-5 0.986328)"
                        />
                      </clipPath>
