...
const Showcase = () => {
      ...
      <section className="py-16   w-full bg-[#04081C]">
        <div className="w-full mx-auto px-6 max-w-screen-xl">
          ...
          >
            ...
            <button
              className="md:mt-4 px-3 md:px-6 flex gap-x-2 py-4 border border-gray-500   bg-transparent
 text-white text-md font-medium rounded-full  transition  items-center text-xs "
            ...
            >
              ...
              >
                <path
                  d="M2.58643 4.66675L5.2531 8.00008L2.58643 11.3334"
                  stroke="white"
                  stroke-width="1.5"
          ...
          <div className="relative ">
            {projects.map((project, index) => (
              <a
                key={index}
                // href={project.link}
                className="block h-full mt-12 space-y-4  shadow-lg rounded-lg overflow-hidden transition transform "
              >
                {/* <img
                  src={project.image}
                  alt={project.title}
