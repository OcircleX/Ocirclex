        ...
        <>    <section className="w-full relative bg-[#171D3F] to-gray-100 py-20  flex flex-col  items-center justify-between">
            <div className="max-w-screen-xl justify-between w-full m-auto">
                <div className="w-full items-center flex flex-col">
                    ...
                    <span className="text-4xl md:text-6xl text-green-500 italic font-serif font-thin">our support</span>

                </div>
                < form className={` m-auto w-1/2 flex flex-wrap p-2 pt-6 mt-[1rem]  rounded-b-md`}>
                    <div className={` w-full flex flex-wrap   rounded-b-md border-0 pt-2 `}>
                        ...
                        <button className="w-full mt-6 px-6 border py-3 bg-[#171D3F] hover:text-[#171D3F] rounded-md text-white text-lg font-medium hover:bg-white transition">
                            SEND MESSAGE
                        </button>
