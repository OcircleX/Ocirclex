...
const hoverLine =
  "relative text-white/85 transition-colors hover:text-white before:absolute before:bottom-0 before:left-1/2 before:h-px before:w-0 before:bg-white before:transition-[width] before:duration-500 before:ease-out hover:before:w-1/2 after:absolute after:bottom-0 after:right-1/2 after:h-px after:w-0 after:bg-white after:transition-[width] after:duration-500 after:ease-out hover:after:w-1/2";

function Footer() {
  return (
    <div className="relative w-full overflow-hidden bg-[#04081C] pt-12 text-white">
      <footer className="relative w-full">
        <div className="mx-auto max-w-screen-xl px-5 py-8 md:px-6">
          <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
            <div>
              <p className="mb-2 text-sm text-white/55">©2026</p>
              <h3 className="text-2xl font-semibold uppercase leading-tight md:text-3xl">
                Let’s start <br />
                work together
              </h3>

              <div className="mt-4 flex flex-col gap-3 py-3 md:hidden">
                <p className="text-lg">• Islamabad, Pakistan</p>
                <a href="mailto:support@ocirclex.com" className="text-lg">
                  • support@ocirclex.com
                </a>
                <a href="tel:+923449622270" className="text-lg">
                  • +92 344 9622270
                </a>
                <Link
            ...
            <Link href="/contact">
              <button
                className="mt-2 flex items-center justify-center gap-3 rounded-full bg-white px-5 py-3 text-base font-medium text-[#04081C] transition hover:bg-[#7BB668] hover:text-[#04081C] md:mt-0 md:px-6 md:text-lg"
              >
                <span className="inline-block h-2.5 w-2.5 rounded-full bg-[#04081C]" />
                START A PROJECT
              </button>
            </Link>
          </div>
        ...
        <div className="mx-auto mb-6 hidden w-full max-w-screen-xl items-center justify-between gap-x-8 px-5 text-sm text-gray-200 md:flex md:px-6">
          <div className={`${hoverLine} flex items-start gap-2 pb-1`}>
            <span>•</span>
            <span>
          ...
          <a href="mailto:support@ocirclex.com" className={`${hoverLine} pb-1`}>
            • support@ocirclex.com
          </a>
          <a href="tel:+923449622270" className={`${hoverLine} pb-1`}>
            • +92 344 9622270
          </a>
          <Link
            href="https://www.linkedin.com/company/circlex/?viewAsMember=true"
        ...
        <div className="flex w-full flex-col-reverse items-end gap-6 pt-2 md:flex-row md:items-end md:gap-8">
          <div className="w-full overflow-x-clip md:w-2/3">
            <CircleXMark className="h-auto w-full max-w-[920px] px-2 md:px-0" />
          </div>

          <div className="w-full px-5 pb-6 text-center sm:flex-1 md:w-1/3 md:px-6 md:pb-10">
...
function CircleXMark({ className = "" }: { className?: string }) {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        fill="url(#footer-cx-6)"
      />
      <defs>
        {[
          ["footer-cx-0", "868.904", "-22.823", "252.791"],
          ["footer-cx-1", "633.669", "-31.6136", "256.964"],
          ["footer-cx-2", "532.976", "-152.178", "258.706"],
          ["footer-cx-3", "378.576", "-31.6136", "256.964"],
          ["footer-cx-4", "246.969", "-28.2131", "253.037"],
          ["footer-cx-5", "143.229", "-153.795", "258.78"],
          ["footer-cx-6", "-58.031", "-150.19", "262.385"],
        ].map(([id, x, y1, y2]) => (
          <linearGradient
            key={id}
            id={id}
