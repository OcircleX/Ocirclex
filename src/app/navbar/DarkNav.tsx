...
useEffect(() => {
  ...
  return (
    <header className="bg-[#04081C] w-full  shadow-md py-4  flex justify-between items-center relative  gap-4" >
          {burgerOn && (
  <div className="w-full  bg-white text-lg text-black absolute top-16 z-20 flex px-4 py-8 md:hidden">
...
{!burgerOn ?  (
    ...
    <path d="M23.3045 21.7783H12.9844" stroke="white" strokeWidth="2.41425" stroke-linecap="round"/>
    <path d="M7.22656 15.2061H23.1214" stroke="white" strokeWidth="2.50529" stroke-linecap="round"/>
    <path d="M7.27344 8.8916H23.2101" stroke="white" strokeWidth="2.50858" stroke-linecap="round"/>
    </g>
    </svg>
) : 
(
 <div className="text-[23px] font-extrabold text-white">      <RxCross1 style={{ strokeWidth: 0.5 }}/>
</div>
