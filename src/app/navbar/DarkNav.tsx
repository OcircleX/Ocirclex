...
useEffect(() => {
 pr()
  ...
  return (
    <header className="bg-[#04081C] w-full  shadow-md py-4 px-6 flex justify-between items-center relative " >
      <div id='hamb' className=" md:w-full  max-w-screen-xl bg-[#04081C] md:gap-0 md:px-0 px-4 flex flex-wrap items-center justify-between mx-auto ">
        <Link href="./"> 
