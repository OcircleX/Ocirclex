...
useEffect(() => {
  ...
  return (
    <header className="w-screen shadow-md py-4 md:px-6 bg-[#fafafa] flex justify-center relative">
      {burgerOn && (
  <div className="w-full  bg-black text-lg text-white absolute top-16 z-20 flex px-4 py-8 md:hidden">
...
<path fillRule="evenodd" clipRule="evenodd" d="M101.757 25.1638L98.6215 19.059H93.0503L99.8951 32.385H94.4625L89.9332 38.7434H95.5045L99.9532 32.4981L103.161 38.7434H108.732L101.773 25.1943H107.307L111.836 18.8359H106.265L101.757 25.1638Z" fill="#7BB668"/>
    ...
    <li
     ...
     {!burgerOn ?  (
         ...
         <path d="M23.3045 21.7783H12.9844" stroke="#171D3F" strokeWidth="2.41425" stroke-linecap="round"/>
         <path d="M7.22656 15.2061H23.1214" stroke="#171D3F" strokeWidth="2.50529" stroke-linecap="round"/>
         <path d="M7.27344 8.8916H23.2101" stroke="#171D3F" strokeWidth="2.50858" stroke-linecap="round"/>
         </g>
         </svg>
     ) : 
     (
      <div className="text-[23px] font-extrabold">      <RxCross1 style={{ strokeWidth: 0.5 }}/>
</div>
